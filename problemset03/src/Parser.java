...
public class Parser {
	...
	private final Pattern pattern = Pattern.compile("^(up|dn|lt|rt)\\s+([0-9]+)$", Pattern.MULTILINE);
	/* This regular expression finds all occurrencies of a string consisting of
	...
	/**
	   ...
	   */
	public List<Action> parseInput(String in){
		...
		while (matcher.find()) {
			...
			System.out.println("###"+dir+" "+Integer.parseInt(matcher.group(2)));
